...
This file is the IRC server for use either between 2 individuals
...
public class IRCServer implements Runnable {
    ...
    public static void main(String[] args) throws Throwable
    {
        ...
        {
            Socket s = ss.accept();
            IRCServer jircs = new IRCServer(s);
    ...
    public enum Command
    {
        NICK(1, 1)
        {
            ...
            private void doSelfSwitchNick(IRCServer con, String nick)
            {
                synchronized (mutex)
                {
            ...
            private void doFirstTimeNick(IRCServer con, String nick)
        ...
        JOIN(1, 2)
        {
            ...
            public void doJoin(IRCServer con, String channelName)
            {
                if (!channelName.startsWith("#"))
                {
                    con
                ...
                synchronized (mutex)
                {
                    ...
                    if (channel.topic != null)
                        ...
                        con.sendGlobal("331 " + con.nick + " " + channel.name
                                + " :No topic is set");
                    for (IRCServer channelMember : channel.channelMembers)
                    {// 353,366
        ...
        PRIVMSG(2, 2)
        {
                    ...
                    throws Exception
            {
                ...
                for (String recipient : recipients)
                {
                    ...
                    {
                        IRCServer recipientIRCServer = connectionMap
                                .get(recipient);
                        if (recipientIRCServer == null)
                            con.sendSelfNotice("The user " + recipient
                                    + " is not online.");
                        else
                            recipientIRCServer.send(":"
        ...
        public abstract void run(IRCServer con, String prefix,
    ...
    private void doServer() throws Exception
    {
        ...
        System.out.println("IRCServer from host " + hostname);
        outThread.start();
